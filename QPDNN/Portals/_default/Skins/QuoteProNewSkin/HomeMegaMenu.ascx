                ...
                <div class="span9">
                    ...
                    <div class="row-fluid" id="MenuDiv">
                        <div id="Mainmenu" class="span10 Menu spmodule"> 
                            <div id="Mmenu" class="hidden-phone QuoteProMegaMenu"> <dnn:MENU ID="MENU1" MenuStyle="DNNMega" runat="server"></dnn:MENU> </div>
                            <div id="Mmenu" class="visible-phone QuoteProDropDown"> <dnn:MENU ID="MENU2" MenuStyle="Superfish" runat="server" /> </div>
                        </div>  
...
<div customsection="edtMenu" customtag=".QuoteProMegaMenu ul.dnnmega > li:not(.mmSelected) > a > span, ul.dnnmega li.root, .Menu" usertext="Main MegaMenu" menutype='Main' disabledcontrols="#BackgroundImage, #BorderColor,.BgColorGrad, .MainStyle"></div>
<div customsection="edtMenu" customtag=".QuoteProMegaMenu ul.dnnmega > li.mmSelected > a" usertext="Main MegaMenu Selected" disabledcontrols="#BackgroundImage, #BorderColor, .MainStyle"></div>
<div customsection="edtMenu" customtag=".QuoteProMegaMenu ul.dnnmega > li > a" menuhover=".QuoteProMegaMenu ul.dnnmega > li > a" menutype='Main' usertext="Main MegaMenu HighLight" disabledcontrols="#BackgroundImage, .MainStyle"></div>
<div customsection="edtMenu" customtag=".QuoteProMegaMenu ul.dnnmega .megaborder .M" menutype='Sub' usertext="Mega Sub Menu" disabledcontrols="#BackgroundImage, .MainStyle"></div>
<div customsection="edtMenu" customtag=".QuoteProMegaMenu ul.dnnmega li.category > a, .QuoteProMegaMenu ul.dnnmega li.category > a > span" menutype='Sub' usertext="Mega Sub Menu Top Level" disabledcontrols="#BackgroundImage, #BorderColor, .BgColorGrad, #Gradient, .MainStyle"></div>
<div customsection="edtMenu" customtag=".QuoteProMegaMenu ul.dnnmega li.category a" menuhover=".QuoteProMegaMenu ul.dnnmega li.category a" menutype='Sub' usertext=" Mega Sub Menu HighLight" disabledcontrols="#BackgroundImage, #BorderColor, .BgColorGrad, #Gradient, .MainStyle"></div>
...
<dnn:QuoteProStyle ID="QuoteProStyle1" runat="server" AddJS="DNNMega/jquery.cycle.min.js" PathNameAlias="SkinPath" />
<dnn:QuoteProStyle ID="QuoteProStyle2" runat="server" AddJS="DNNMega/jquery.dnnmega.debug.js" PathNameAlias="SkinPath" />
<dnn:QuoteProStyle ID="QuoteProStyle3" runat="server" AddCSS="DNNMega/dnnmega.css" PathNameAlias="SkinPath" />
<dnn:QuoteProStyle ID="QuoteProStyle4" runat="server" AddJS="DNNMega/jquery.hoverIntent.min.js" PathNameAlias="SkinPath" />
<!-------------------------------------------------->
