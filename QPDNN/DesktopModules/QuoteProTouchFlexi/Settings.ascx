<%@ Control Language="C#" AutoEventWireup="false" Inherits="QuoteProApp.Modules.QuoteProTouchFlexi.Settings" Codebehind="Settings.ascx.cs" %>
...
<table id="box-table-a">
    ...
    <tr>
        <th align="center"  colspan="4">
            <strong>QuoteProApplication.com - Touch Flexi Slider Settings</strong></th>
    </tr>
    </thead>
    <tr>
        <td class="tdRight">
